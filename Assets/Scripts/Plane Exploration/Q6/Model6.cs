...
public class Model6 : MonoBehaviour {

	private GameObject ModelGameObject;

	private Vector3[] curve1, top1, top2, bottom1, right1, left1, front1, back1, back2, supple1, supple2, supple3;
	...
	void Start () {
		...
		edgeTrack = new Vector3[] {
			...
			new Vector3 (0, 2, 3),
			new Vector3 (1, 2, 3), 
			new Vector3 (1, 2, 1.02f), 
			new Vector3 (1, 1.01f, 1.02f),
			new Vector3 (0, 1.01f, 1.02f),
			new Vector3 (1, 1.01f, 1.02f),
	...
	public void InitializeLog(){
		logObject.GetComponent<PlaneExplorationLog> ().RecordInitialization (trialNum, 6);
		trialNum++;
	}
	...
	void Update () {
		...
		mesh.vertices = new Vector3[] {
			...
			supple1[0], supple1[1], supple1[3],
			supple1[3], supple1[1], supple1[2],
			supple2[0], supple2[1], supple2[3],
			supple2[3], supple2[1], supple2[2],
			supple3[0], supple3[1], supple3[3],
			supple3[3], supple3[1], supple3[2], // 68
		...
		mesh.triangles = new int[] {
			...
			180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, // 65
	...
	Vector3[] GetBack(int segNum) {
		...
		float r = 1, dStart = 270, dEnd = 360;
		Vector3 p = new Vector3 (0, 2, 2);

		s0 = new Vector3 (0, 1, 2);
